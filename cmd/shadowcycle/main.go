...
func main() {
	...
	// cube.Transform(transform.NewMoveAction(vector.NewVector3d(0, 0, 20)))
	...
	// 	panic(err)
	// }
	// cube2.Transform(transform.NewMoveAction(vector.NewVector3d(20, 0, 0)))
	...
	// 	panic(err)
	// }
	// cube3.Transform(transform.NewMoveAction(vector.NewVector3d(0, 0, -20)))
	...
	light1 := object.NewPointLight(color.RGBA{255, 255, 255, 255}, *vector.NewVector3d(20, 0, 0))
	// light2 := object.NewPointLight(color.RGBA{255, 255, 255, 255}, *vector.NewVector3d(0, 20, 0))
	...
	sim.SetCamera(cam)
	sim.AddObject(cube, *vector.NewVector3d(0.2, 0, 0), 1000000000)
	// sim.AddObject(cube2, *vector.NewVector3d(0, 0, -.2), 1000000000)
	// sim.AddObject(cube3, *vector.NewVector3d(-.2, 0, 0), 1000000000)
	// sim.AddObject(cube4, *vector.NewVector3d(0, 0, .2), 1000000000)
	// sim.AddObject(cube5, *vector.NewVector3d(0, 0, 0), 1000000000)
	sim.AddLight(light1)
	// sim.AddLight(light2)
	// sim.AddLight(light3)
	// sim.AddLight(light4)
