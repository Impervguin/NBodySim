...
\begin{thebibliography}{}
	...
	\bibitem{shadowstep} OpenGL 11: Shadows Part 1 - Directional Shadows // Kovalev's Corner URL: https://rekovalev.site/opengl-11-shadows-p1/ (дата обращения: 11.12.2024).
	\bibitem{go} The Go Programming Language // URL: https://go.dev/ (дата обращения: 07.12.2024).
	\bibitem{fyne} Website for the fyne app development framework // URL: https://fyne.io/ (дата обращения: 07.12.2024).
	\bibitem{cover} The cover story // The Go Programming Lamguage URL: https://go.dev/blog/cover (дата обращения: 07.12.2024).
